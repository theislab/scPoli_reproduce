...
for experiment in experiments:
    for test_nr in test_nrs:
        ...
        scvi.data.setup_anndata(adata_ref, batch_key=condition_key, labels_key=cell_type_key)
        ...
        dir_path_scan = os.path.expanduser(
            f"~/Documents/scanvi_benchmarks/batchwise/surg/{experiment}/{test_nr}_ref_model/")
        vae_ref_scan.save(dir_path_scan, overwrite=True)
        text_file_r = open(
            os.path.expanduser(f"~/Documents/scanvi_benchmarks/batchwise/surg/{experiment}/{test_nr}_ref_runtime.txt"),
            "w")
        ...
        dir_path_scan = os.path.expanduser(f"~/Documents/scanvi_benchmarks/batchwise/surg/{experiment}/{test_nr}_model/")
        ...
        checks = np.array(len(adata_query) * ['incorrect'])
        checks[preds == adata_query.obs[cell_type_key]] = 'correct'

        text_file_q = open(
            os.path.expanduser(
                f'~/Documents/scanvi_benchmarks/batchwise/surg/{experiment}/{test_nr}_query_acc_report.txt'),
            "w")
        n = text_file_q.write(classification_report(
            y_true=adata_query.obs[cell_type_key],
            y_pred=preds,
            labels=np.array(adata_query.obs[cell_type_key].unique().tolist())
        ))
        text_file_q.close()
        correct_probs = probs[preds == adata_query.obs[cell_type_key]]
        incorrect_probs = probs[preds != adata_query.obs[cell_type_key]]
        ...
        plt.savefig(os.path.expanduser(
            f'~/Documents/scanvi_benchmarks/batchwise/surg/{experiment}/{test_nr}_query_uncertainty.png'),
            bbox_inches='tight')
        ...
        adata_latent.write_h5ad(filename=os.path.expanduser(
            f'~/Documents/scanvi_benchmarks/batchwise/surg/{experiment}/{test_nr}_query_adata.h5ad'))
        ...
        plt.savefig(
            os.path.expanduser(
                f'~/Documents/scanvi_benchmarks/batchwise/surg/{experiment}/{test_nr}_query_umap_batch.png'),
            bbox_inches='tight')
        plt.close()
        sc.pl.umap(adata_latent,
                   color=['celltype'],
        ...
        plt.savefig(
            os.path.expanduser(
                f'~/Documents/scanvi_benchmarks/batchwise/surg/{experiment}/{test_nr}_query_umap_ct.png'),
            bbox_inches='tight')
        plt.close()
        sc.pl.umap(adata_latent,
                   color=['predictions'],
        ...
        plt.savefig(
            os.path.expanduser(
                f'~/Documents/scanvi_benchmarks/batchwise/surg/{experiment}/{test_nr}_query_umap_pred.png'),
            bbox_inches='tight')
        plt.close()
        sc.pl.umap(adata_latent,
                   color=['checking'],
        ...
        plt.savefig(
            os.path.expanduser(
                f'~/Documents/scanvi_benchmarks/batchwise/surg/{experiment}/{test_nr}_query_umap_checks.png'),
            bbox_inches='tight')
        plt.close()
        ...
        checks[preds == adata_full.obs[cell_type_key]] = 'correct'

        text_file_q = open(
            os.path.expanduser(
                f'~/Documents/scanvi_benchmarks/batchwise/surg/{experiment}/{test_nr}_full_acc_report.txt'),
            "w")
        n = text_file_q.write(classification_report(
            y_true=adata_full.obs[cell_type_key],
            y_pred=preds,
        ))
        text_file_q.close()
        correct_probs = probs[preds == adata_full.obs[cell_type_key]]
        incorrect_probs = probs[preds != adata_full.obs[cell_type_key]]
        data = [correct_probs, incorrect_probs]
        fig, ax = plt.subplots()
        ax.set_title('Default violin plot')
        ax.set_ylabel('Observed values')
        ...
        set_axis_style(ax, labels)
        plt.savefig(os.path.expanduser(
            f'~/Documents/scanvi_benchmarks/batchwise/surg/{experiment}/{test_nr}_full_uncertainty.png'),
            bbox_inches='tight')
        ...
        plt.savefig(
            os.path.expanduser(
                f'~/Documents/scanvi_benchmarks/batchwise/surg/{experiment}/{test_nr}_full_umap_batch.png'),
            bbox_inches='tight')
        plt.close()
        sc.pl.umap(adata_latent,
                   color=['celltype'],
        ...
        plt.savefig(
            os.path.expanduser(
                f'~/Documents/scanvi_benchmarks/batchwise/surg/{experiment}/{test_nr}_full_umap_ct.png'),
            bbox_inches='tight')
        plt.close()
        sc.pl.umap(adata_latent,
                   color=['predictions'],
        ...
        plt.savefig(
            os.path.expanduser(
                f'~/Documents/scanvi_benchmarks/batchwise/surg/{experiment}/{test_nr}_full_umap_pred.png'),
            bbox_inches='tight')
        plt.close()
        sc.pl.umap(adata_latent,
                   color=['checking'],
        ...
        plt.savefig(
            os.path.expanduser(
                f'~/Documents/scanvi_benchmarks/batchwise/surg/{experiment}/{test_nr}_full_umap_checks.png'),
            bbox_inches='tight')
        plt.close()
