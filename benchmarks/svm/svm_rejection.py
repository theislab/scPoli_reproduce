...
for experiment in experiments:
    for test_nr in test_nrs:
        ...
        text_file = open(os.path.expanduser(
            f"~/Documents/svm_benchmarks/batchwise/{experiment}/{test_nr}_acc_report_updated.txt"), "w")
        ...
        text_file_f = open(os.path.expanduser(
            f"~/Documents/svm_benchmarks/batchwise/{experiment}/{test_nr}_acc_report_full.txt"), "w")
        m = text_file_f.write(classification_report(y_true=full_Y, y_pred=full_predicted))
        text_file_f.close()
