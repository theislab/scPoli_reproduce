...
def init_dataset():
    ...
    test_maca = MacaData(
        "tabula-muris-senis-facs-official-annotations.h5ad",
    ...
    for tissue in tissues:
        ...
        pretrain_data.append(
            ExperimentDataset(
                tiss_test.X.toarray(), tiss_test.obs_names, tiss_test.var_names, tissue
            )
        )
...
def main():
    ...
    for idx, unlabeled_data in enumerate(test_data):
        ...
        print(
            "{}: Acc {}, F1_score {}, NMI {}, Adj_Rand {}, Adj_MI {}".format(
                unlabeled_data.metadata,
                scores["accuracy"],
                scores["f1_score"],
                scores["nmi"],
                scores["adj_rand"],
