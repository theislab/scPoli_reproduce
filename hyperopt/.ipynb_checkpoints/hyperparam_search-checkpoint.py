...
OPT_PARAMS = ['eta', 'latent_dim', 'alpha_epoch_anneal', 'loss_metric', 'clustering_res']
...
def objective(params):
    ...
    results_dict = tranvae_query.classify(adata.X, adata.obs[condition_key], metric=params['loss_metric'])
