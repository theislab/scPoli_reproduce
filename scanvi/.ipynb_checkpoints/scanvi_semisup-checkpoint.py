...
for experiment in experiments:
    for test_nr in test_nrs:
        ...
        text_file_t = open(
            os.path.expanduser(f"~/Documents/scanvi_benchmarks/batchwise/semi/{experiment}/{test_nr}_runtime.txt"), "w")
        ...
        adata_latent = sc.AnnData(scanvi_model.get_latent_representation(unlabeled_adata))
        ...
        text_file_f = open(
            os.path.expanduser(
                f'~/Documents/scanvi_benchmarks/batchwise/semi/{experiment}/{test_nr}_full_acc_report.txt'), "w")
